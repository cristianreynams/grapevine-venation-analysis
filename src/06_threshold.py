...
INPUT_ROOT = "data/processed/frangi"
...
def threshold_vessels(image_path):
...
def debug_mode(folder_name):
    ...
    for i, (name, frangi, binary) in enumerate(results):
